import {
  ...
  trimPath,
  useStore
} from "./chunk-WHIBEGDG.js";
import "./chunk-Q3YFGCWB.js";
import {
  require_react
...
var TanStackRouterDevtoolsPanel = import_react.default.forwardRef(function TanStackRouterDevtoolsPanel2(props, ref) {
  ...
  const allMatches = import_react.default.useMemo(() => [...Object.values(router.state.matches)], [router.state.matches]);
  const activeMatch = allMatches == null ? void 0 : allMatches.find((d) => d.route.id === activeRouteId);
  const hasSearch = Object.keys(((_a = last(router.state.matches)) == null ? void 0 : _a.state.search) || {}).length;
  return import_react.default.createElement(ThemeProvider, {
    ...
    activeRouteId,
    setActiveRouteId
  }) : import_react.default.createElement("div", null, router.state.matches.map((match, i) => {
  ...
  }, "Status"), import_react.default.createElement("td", null, activeMatch.state.status)), import_react.default.createElement("tr", null, import_react.default.createElement("td", {
    style: {
      opacity: ".5"
    }
  }, "Last Updated"), import_react.default.createElement("td", null, activeMatch.state.updatedAt ? new Date(activeMatch.state.updatedAt).toLocaleTimeString() : "N/A"))))), import_react.default.createElement("div", {
    style: {
      background: defaultTheme.backgroundAlt,
      padding: ".5em",
      position: "sticky",
    ...
    value: ((_b = last(router.state.matches)) == null ? void 0 : _b.state.search) || {},
    defaultExpanded: Object.keys(((_c = last(router.state.matches)) == null ? void 0 : _c.state.search) || {}).reduce((obj, next) => {
      obj[next] = {};
      return obj;
    }, {})
  }))) : null));
