...
var useUnmountEffect = function useUnmountEffect2(fn) {
  return React7.useEffect(function() {
    return fn;
  }, []);
};
var useTimeout = function useTimeout2(fn) {
  ...
  var timeout2 = React7.useRef(null);
  var savedCallback = React7.useRef(null);
  var clear = React7.useCallback(function() {
...
var Portal = React9.memo(function(inProps) {
  ...
  var _React$useState = React9.useState(props.visible && DomHandler.hasDOM()), _React$useState2 = _slicedToArray(_React$useState, 2), mountedState = _React$useState2[0], setMountedState = _React$useState2[1];
...
var TimesIcon = React10.memo(React10.forwardRef(function(inProps, ref) {
  ...
  return React10.createElement("svg", _extends2({
    ref,
    width: "14",
    height: "14",
    viewBox: "0 0 14 14",
...
var Ripple = React11.memo(React11.forwardRef(function() {
  var inkRef = React11.useRef(null);
  var targetRef = React11.useRef(null);
  ...
  return context && context.ripple || PrimeReact.ripple ? React11.createElement("span", {
    role: "presentation",
    ref: inkRef,
    className: "p-ink",
    onAnimationEnd
...
var ToastMessage = React12.memo(React12.forwardRef(function(props, ref) {
  ...
  var parentParams = _objectSpread2(_objectSpread2({}, parentMetaData), params);
  var _React$useState = React12.useState(false), _React$useState2 = _slicedToArray2(_React$useState, 2), focused = _React$useState2[0], setFocused = _React$useState2[1];
  var _useTimeout = useTimeout(function() {
    onClose();
  }, life || 3e3, !sticky && !focused), _useTimeout2 = _slicedToArray2(_useTimeout, 1), clearTimer = _useTimeout2[0];
  ...
  var createCloseIcon = function createCloseIcon2() {
    ...
    var icon = _closeIcon || React12.createElement(TimesIcon, buttonIconProps);
    var closeIcon2 = IconUtils.getJSXIcon(icon, _objectSpread2({}, buttonIconProps), {
      props
    });
    ...
    if (closable !== false) {
      return React12.createElement("div", null, React12.createElement("button", buttonProps, closeIcon2, React12.createElement(Ripple, null)));
    }
    return null;
  };
  var createMessage = function createMessage2() {
    if (messageInfo) {
      ...
      if (!_icon) {
        switch (severity) {
          case "info":
            icon = React12.createElement(InfoCircleIcon, iconProps);
            break;
          case "warn":
            icon = React12.createElement(ExclamationTriangleIcon, iconProps);
            break;
          case "error":
            icon = React12.createElement(TimesCircleIcon, iconProps);
            break;
          case "success":
            icon = React12.createElement(CheckIcon, iconProps);
            break;
        }
      }
      var messageIcon = IconUtils.getJSXIcon(icon, _objectSpread2({}, iconProps), {
        props
      });
      ...
      return contentEl || React12.createElement(React12.Fragment, null, messageIcon, React12.createElement("div", textProps, React12.createElement("span", summaryProps, summary), detail && React12.createElement("div", detailProps, detail)));
    }
    return null;
  };
  var className = classNames("p-toast-message", _defineProperty2({}, "p-toast-message-".concat(severity), severity), _className);
  ...
  return React12.createElement("div", messageProps, React12.createElement("div", contentProps, message, closeIcon));
}));
ToastMessage.displayName = "ToastMessage";
var messageIdx = 0;
var Toast = React12.memo(React12.forwardRef(function(inProps, ref) {
  var context = React12.useContext(PrimeReactContext);
  var props = ToastBase.getProps(inProps, context);
  var _React$useState = React12.useState([]), _React$useState2 = _slicedToArray2(_React$useState, 2), messagesState = _React$useState2[0], setMessagesState = _React$useState2[1];
  ...
  var createElement5 = function createElement6() {
    ...
    return React12.createElement("div", rootProps, React12.createElement(TransitionGroup_default, null, messagesState && messagesState.map(function(messageInfo, index) {
      var messageRef = React12.createRef();
      return React12.createElement(CSSTransition2, {
        nodeRef: messageRef,
      ...
      }, React12.createElement(ToastMessage, {
        ref: messageRef,
        messageInfo,
        index,
