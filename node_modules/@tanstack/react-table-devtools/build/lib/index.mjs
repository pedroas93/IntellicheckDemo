...
const DefaultRenderer = _ref2 => {
  ...
  const [valueSnapshot, setValueSnapshot] = React__default.useState(undefined);
  const [expandedPages, setExpandedPages] = React__default.useState([]);
  ...
  return /*#__PURE__*/React__default.createElement(Entry, {
    ...
    expanded: expanded
  }), " ", label, ' ', /*#__PURE__*/React__default.createElement(Info, null, String(type).toLowerCase() === 'iterable' ? '(Iterable) ' : '', subEntries.length, " ", subEntries.length > 1 ? `items` : `item`)), expanded ? subEntryPages.length === 1 ? /*#__PURE__*/React__default.createElement(SubEntries, null, subEntries.map(entry => handleEntry(entry))) : /*#__PURE__*/React__default.createElement(SubEntries, null, subEntryPages.map((entries, index) => /*#__PURE__*/React__default.createElement("div", {
    key: index
    ...
    expanded: expanded
  }), " [", index * pageSize, " ...", ' ', index * pageSize + pageSize - 1, "]"), expandedPages.includes(index) ? /*#__PURE__*/React__default.createElement(SubEntries, null, entries.map(entry => handleEntry(entry))) : null)))) : null) : type === 'function' ? /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(Explorer, {
    renderer: renderer,
    ...
    value: valueSnapshot,
    defaultExpanded: {}
  })) : /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(Label, null, label, ":"), ' ', /*#__PURE__*/React__default.createElement(Value, null, JSON.stringify(value, Object.getOwnPropertyNames(Object(value))))));
};
function Explorer(_ref3) {
  ...
  return renderer({
    handleEntry: entry => /*#__PURE__*/React__default.createElement(Explorer, _extends({
      key: entry.label,
      renderer: renderer
    }, rest, entry)),
    type,
...
function ReactTableDevtools(_ref) {
  ...
  const [isOpen, setIsOpen] = useLocalStorage('reactTableDevtoolsOpen', initialIsOpen);
  ...
  return /*#__PURE__*/React__default.createElement(Container, {
    ...
    theme: defaultTheme
  }, !isOpen ? /*#__PURE__*/React__default.createElement("button", _extends({
    type: "button"
  }, otherToggleButtonProps, {
    ...
    "aria-hidden": true
  })) : /*#__PURE__*/React__default.createElement(ReactTableDevtoolsPanel, _extends({
    ref: panelRef
  }, otherPanelProps, {
    table: table,
    isOpen: isOpen,
...
const ReactTableDevtoolsPanel = /*#__PURE__*/React__default.forwardRef(function ReactTableDevtoolsPanel(props, ref) {
  const {
    table,
    isOpen = true,
    setIsOpen,
  ...
  }, "React Table", ' ', /*#__PURE__*/React__default.createElement("span", {
    style: {
      fontWeight: 100
    }
  ...
  }, isOpen ? /*#__PURE__*/React__default.createElement(Button, {
    type: "button",
    "aria-label": "Close React Table Devtools",
    onClick: () => {
      setIsOpen(false);
    }
  }, "Close") : null)), /*#__PURE__*/React__default.createElement("div", {
    style: {
      display: 'flex',
      flexWrap: 'wrap',
      overflowY: 'auto',
...
export { ReactTableDevtools, ReactTableDevtoolsPanel };
