...
(function (global, factory) {
  ...
  const DefaultRenderer = _ref2 => {
    ...
    return /*#__PURE__*/React.createElement(Entry, {
      key: label
    }, subEntryPages != null && subEntryPages.length ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Label, {
      onClick: () => toggle()
    }, /*#__PURE__*/React.createElement(Expander, {
      expanded: expanded
    }), " ", label, ' ', /*#__PURE__*/React.createElement(Info, null, String(type).toLowerCase() === 'iterable' ? '(Iterable) ' : '', subEntries.length, " ", subEntries.length > 1 ? `items` : `item`)), expanded ? subEntryPages.length === 1 ? /*#__PURE__*/React.createElement(SubEntries, null, subEntries.map(entry => handleEntry(entry))) : /*#__PURE__*/React.createElement(SubEntries, null, subEntryPages.map((entries, index) => /*#__PURE__*/React.createElement("div", {
      key: index
      ...
      value: valueSnapshot,
      defaultExpanded: {}
    })) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Label, null, label, ":"), ' ', /*#__PURE__*/React.createElement(Value, null, JSON.stringify(value, Object.getOwnPropertyNames(Object(value))))));
  };
  ...
  function ReactTableDevtools(_ref) {
    ...
    return /*#__PURE__*/React.createElement(Container, {
      ...
      theme: defaultTheme
    }, !isOpen ? /*#__PURE__*/React.createElement("button", _extends({
      type: "button"
    }, otherToggleButtonProps, {
      ...
      "aria-hidden": true
    })) : /*#__PURE__*/React.createElement(ReactTableDevtoolsPanel, _extends({
      ref: panelRef
    }, otherPanelProps, {
      table: table,
      isOpen: isOpen,
  ...
  const ReactTableDevtoolsPanel = /*#__PURE__*/React.forwardRef(function ReactTableDevtoolsPanel(props, ref) {
    const {
      table,
      isOpen = true,
      setIsOpen,
    ...
    }, "React Table", ' ', /*#__PURE__*/React.createElement("span", {
      style: {
        fontWeight: 100
      }
