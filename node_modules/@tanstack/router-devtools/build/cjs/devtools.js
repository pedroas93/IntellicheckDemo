...
const TanStackRouterDevtoolsPanel = /*#__PURE__*/React__default["default"].forwardRef(function TanStackRouterDevtoolsPanel(props, ref) {
  ...
  const hasSearch = Object.keys(router.last(router$1.state.matches)?.state.search || {}).length;
  return /*#__PURE__*/React__default["default"].createElement(theme.ThemeProvider, {
    ...
    value: router.last(router$1.state.matches)?.state.search || {},
    defaultExpanded: Object.keys(router.last(router$1.state.matches)?.state.search || {}).reduce((obj, next) => {
      obj[next] = {};
      return obj;
    }, {})
  }))) : null));
